...
class NVTheme {
  ...
  static TextTheme _textTheme(Color tc, Color mc) {
    return TextTheme(
      displayLarge: TextStyle(color: tc, fontWeight: FontWeight.w700, letterSpacing: -1),
      headlineLarge: TextStyle(color: tc, fontWeight: FontWeight.w700, letterSpacing: -0.8),
      headlineMedium: TextStyle(color: tc, fontWeight: FontWeight.w700, letterSpacing: -0.6),
      titleLarge: TextStyle(color: tc, fontWeight: FontWeight.w700, letterSpacing: -0.3),
      ...
      labelSmall: TextStyle(color: mc, fontSize: 11, letterSpacing: 1, fontWeight: FontWeight.w600),
    );
  }
}
