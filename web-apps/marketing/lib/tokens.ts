// Mirror of web/shared/tokens.ts. Each Next.js app owns its copy
// because Turbopack won't resolve imports outside the project root.
// Update both files together when tokens change.
